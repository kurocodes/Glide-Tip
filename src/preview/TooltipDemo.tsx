  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-6 z-50 rounded-md font-medium overflow-hidden bg-[hsl(0deg_0%_90%)]"
      >
        <motion.div
          animate={{
            x: -offset,
      ...
      >
        {labels.map((_, i) => (
          ...
          >
            <div className="h-1 w-[80%] rounded-full transition-colors duration-300 bg-[hsl(0deg_0%_40%)] group-hover:bg-[hsl(0deg_0%_90%)]" />
          </div>
        ))}
      </div>
    </div>
